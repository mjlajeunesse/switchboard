...
# Lajeunesse 9/22/201 added microswitches
...
namespace eval ttk::theme::azure {
    ...
    ttk::style theme create azure -parent default -settings {
		...
		# LAJEUNESSE: 9/22/2021
		ttk::style layout MicroSwitch {
            MicroSwitch.button -children {
                MicroSwitch.padding -children {
                    MicroSwitch.indicator -side left
                    MicroSwitch.label -side left -expand true
                }
            }
        }
		...
		# Lajeunesse: 9/22/2021
		# MicroSwitch
        ttk::style element create MicroSwitch.indicator image \
            [list $I(micro-off-basic) \
                {selected disabled} $I(micro-on-basic) \
                disabled $I(micro-off-basic) \
                {pressed selected} $I(micro-on-hover) \
                {active selected} $I(micro-on-hover) \
                selected $I(micro-on-accent) \
                {pressed !selected} $I(micro-off-hover) \
                active $I(micro-off-hover) \
            ] -width 23 -sticky w
