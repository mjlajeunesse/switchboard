...
#'
#' The \code{progress_ibis} widget displays an ibis -- a long-legged, long-beak
#'    wading bird -- as a progressBar.
#'
#' @section Usage:
#'    \preformatted{progress_ibis(eavesdrop, maximum = 100, size = 1,
...
#' @inheritParams progress_ibis
#' @import tcltk magrittr
#' @export
progress_ibis <- function(.switchboard, ...) {
  switchboard_engine(.switchboard,
                     constructor = progress_image_construct(.switchboard,
                                                            file = system.file("images", "ibis.png", package = "switchboard"), ...),
