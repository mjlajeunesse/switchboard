...
#'
#' The \code{progress_oyster} widget displays the Der naturen bloeme "angry oyster"
#'    as a progressBar. Scholars thinks it's more of a fan mussel, but it's still
#'    clearly angry at someone, something, or itself.
#'
#' @section Usage:
#'    \preformatted{progress_oyster(eavesdrop, maximum = 100, size = 1,
...
#' @name progress_oyster
NULL


#' @inheritParams progress_oyster
#' @import tcltk magrittr
#' @export
progress_oyster <- function(.switchboard, ...) {
  switchboard_engine(.switchboard,
                     constructor = progress_image_construct(.switchboard,
                                                            file = system.file("images", "oyster.png", package = "switchboard"), ...),
